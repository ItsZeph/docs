...
Common Sense must be used in ou community. If a rule is not listed here, but is a common rule in other communities, then you may still be moderated for it.
