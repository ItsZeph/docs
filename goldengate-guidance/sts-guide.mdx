...
### Approval
You can only host an STS with permission from the Highest Rank online **(Excluding Directorial Board)**, as long as it is under these reasons:
...
<Frame type="glass">
![STS Guide](https://res.cloudinary.com/dmgrk6mbc/image/upload/v1732805260/STS_MAP_4_qekwmu.png)
</Frame>
...
Hello everyone, and welcome to Maple Ontario Roleplay.
...
We will now begin with our In-Game Server Rules which you can find at anytime in our rules channel.

Here at Maple Ontario Roleplay we dedicate to a realistic atmosphere, to maintain this, we have the following Realism Based Guidelines.
...
At Maple Ontario, RDM and VDM is strictly prohibited.

When an EMS or LEO is sounding their lights and sirens, you must then yield to them.

'Roleplay Motions' must be maintained at all times. Gun Motion is no longer required for handguns, but is required for heavy weapons such as the AK-47. Cuff Motions are not required.

You must not interrupt, or involve yourself in an RP Scene that does not concern you.

At Maple Ontario Roleplay, you must have a realistic avatar.
