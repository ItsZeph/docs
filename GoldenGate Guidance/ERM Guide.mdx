...
For the Discord Bot, you must run the `/duty manage` command in the commands channel within the Staff Section, you must do this to Start, go on/off break, and stop your shift.
