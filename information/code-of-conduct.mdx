...
<Warning>Please ensure common sense is used when moderating or talking within Maple Ontario Roleplay, as you may still be infracted for rules not placed here.</Warning>
...
Whilst as Staff with Maple Ontario Roleplay, you must maintain the following:
...
* A fully completed profile, this includes:
  ...
  * Our Discord Link must be in your bio. (https://discord.gg/morp)

* Your statuses must not include any profanity, or hints into personal life.

<Info>Exceptions can be made to any of the above policies, with approval from a Directorial Board Member for a valid reason.</Info>
...
<Info>In this category, we will explain what we expect of you whilst as Staff with Maple Ontario Roleplay.</Info>

### 1. Respect

Whilst as Staff with Maple Ontario you must ensure you are staying respectful at all times, this includes but is not limited to:
...
Staff must not use their role to gain a position in any department inside Maple Ontario Roleplay.
...
All Staff must react to any official reactions posted onto Staff and Server Announcements, Staff must also not disregard orders or DMs from the Directorial Board, and must respond in a timely manner.

### 6. Assets

All assets made for the use of Maple Ontario, remains the property of the server, and must not be copied wihout prior permission. Refer to the [Asset Policy](https://staff.osrp.site/Information/Asset%20Policy) for more information.
...
**If you react to an SSU, and fail to join within 5 minutes, you will receive a full rank termination.**
...
On order of the Director of Maple Ontario Roleplay, he has decided it is of the best interest of the Maple Ontario Roleplay Staffing Program to re-implement Rule #13, preventing the employment at other communities. An exception of this rule, Server Owners, and ONLY Server Owners are immune from this rule for their communities only. Members of Staff, inside Oceanview Customs will also be immune from this policy

# Recording/Picture Shoot Expectations

<Info>The Maple Ontario Directorial Board hosts recordings/shoots for various promotional videos/pictures overtime, these rules help us streamline our recordings to make them more effective and professional.</Info>
