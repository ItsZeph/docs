...
All Staff must react to any official reactions posted onto Staff and Server Announcements, Staff must also not disregard orders or DMsfrom Executive Board, and must respond in a timely manner.

### 6. Assets
All assets made for the use of OSRP, remains the property of the server, and must not be copied wihout prior permission.

### 7. Pinging
Pinging Executive Board is strictly prohibited, as this disrupts the workflow of the server.
...
<Info>The OSRP Executive Board hosts recordings for various promotional videos overtime, these rules help us streamline our recordings to make them more effective and professional.</Info>

### 1. Authority
The Executive Board holds control over the recording, meaning anything you are asked to do/go to, you must act upon that without arguing in a timely manner.

### 2. PTS
Recordings must stay organized at all times, to uphold this we enforce a PTS (Permission to Speak) system. This requires you to say 'PTS' and wait for a approval from an Executive Board Member before allowing you to speak.
